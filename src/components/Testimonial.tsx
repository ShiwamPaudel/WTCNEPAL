    ...
    <div className='h-[100%] w-full bg-[#1CABD3CC]/[0.8] absolute left-0 top-0'>
     ...
     <div className="container mx-auto flex flex-col md:flex-row  ">
        <div className="md:basis-[40%]  md:ml-[0px] relative z-30">
            ...
            <h1 className="font-IBM uppercase text-[30px] md:text-[36px] text-center md:text-left leading-[47px] text-[#fff]  font-extrabold pr-[10px] pt-[4px] whitespace-pre">What Our Students Say</h1>
