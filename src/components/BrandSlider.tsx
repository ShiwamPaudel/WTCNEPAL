...
const brands: Brand[] = [
  ...
  { name: 'Brand 9', image: '/assets/Partners/Avantors.png', url: 'https://www.avantorsciences.com/global/' },
  ...
  { name: 'Brand 12', image: '/assets/Partners/Diverseys.png', url: 'https://diversey.com/en' },
