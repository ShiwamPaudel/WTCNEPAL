...
const Asked = () => {
  return (
    <div className="bg-white pb-[91px] px-[15px] md:px-0">
     ...
     <h2 className="font-IBM font-normal uppercase text-4xl leading-[47px] text-[#0D1250] text-center pt-[4px]">Frequently Asked Questions</h2>
     <div className="container 2xl:max-w-[1180px] mx-auto flex items-center md:flex-row flex-col  gap-[40px] mt-[49px]">
      ...
      <div className='basis-[40%]'>
         ...
         <img src="/../assets/faq.jpg" alt="" className='h-[552px] w-full object-cover '/>
      </div>
     </div>
    </div>
  )
